...
export function buildElectricityReceiptHtml(params: {
  ...
  <body>
    <div class="receipt">
      ...
      <div class="footer">Keep this receipt for your records. Generated by KaysPay.</div>
    </div>
  </body></html>`;
}
...
export function buildNinCorrectionReceiptHtml(params: {
  ...
  <body>
    <div class="receipt">
      ...
      <div class="footer">Generated by KaysPay · kayspay.com.ng</div>
    </div>
  </body></html>`;
}
    ...
    <div class="receipt">
      <div class="header">
        <div class="brand-row">
          ...
          <span class="brand-name">KaysPay</span>
        </div>
      ...
      <div class="card">
        <table>
          ...
          <tr><td class="label">Sender</td><td class="value">${escapeHtml(senderName)}<span class="sub">KaysPay Wallet</span></td></tr>
