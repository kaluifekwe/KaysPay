...
const nav = [["Home","/"],["Services","/services"],["About","/about"],["Help","/help"]];
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="en"><body>
    ...
    <main>{children}</main>
    <footer><div className="shell footer-grid"><div><div className="brand light">KaysPay</div><p>Everyday payments, made simple.</p></div><div><strong>Company</strong><Link href="/about">About</Link><Link href="/security">Security</Link><Link href="/contact">Contact</Link></div><div><strong>Guides</strong><Link href="/choosing-a-vtu-app">Choosing a VTU app</Link><Link href="/failed-transactions">Failed purchases and refunds</Link><Link href="/pay-bills-from-abroad">Paying bills from abroad</Link></div><div><strong>Legal</strong><a href="/privacy/">Privacy &amp; Terms</a><a href="/#analytics-preferences">Analytics preferences</a><a href="/delete-account/">Delete account</a></div></div><div className="shell fine">KaysPay is a product of Kay&apos;s Limited (RC 9705891). © 2026 Kay&apos;s Limited.</div></footer>
    <AnalyticsConsent />
  </body></html>;
}
