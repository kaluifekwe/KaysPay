...
// a network fee — charged ON TOP of the amount sold, not taken out of the
...
// at 1.00 USDT, selling 3 USDT cost 4 and returned about ₦4,134 — an
// effective ₦1,034 per USDT against a ₦1,378 headline, so a quarter of the
