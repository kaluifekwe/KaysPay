...
serve(async (req: Request) => {
  ...
  // The database hashes this subject before persistence. The generic response
  // preserves account-enumeration resistance even when the limit is reached.
  ...
  if (!rate.allowed) return json(GENERIC);
