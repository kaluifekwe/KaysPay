...
const scenes=[
  ['01-intro.mp3','Your everyday services should be simple. Open KaysPay and bring payments, connectivity, crypto, eSIM, and NIN services together in one convenient app.'],
  ['02-airtime-data.mp3','Need airtime or data now? Open KaysPay, choose your network, enter the phone number, select an amount, and confirm. Stay connected without unnecessary stress.'],
  ...
  ['08-outro.mp3','Airtime, data, bills, crypto, eSIM and NIN, all in one app. Download KaysPay, create your account, and start today. Pay smarter. Live easier.'],
];
